...
echo_and_run cd "/home/julius_robo3/GrabbyCatkinWS/src/rosserial/rosserial_vex_cortex"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/julius_robo3/GrabbyCatkinWS/src/rosserial/rosserial_vex_cortex/setup.py" \
     \
    build --build-base "/home/julius_robo3/GrabbyCatkinWS/build/rosserial/rosserial_vex_cortex" \
    install \
    --root="${DESTDIR-/}" \
